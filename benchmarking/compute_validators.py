...
from pytorch_adapt.datasets import get_mnist, get_mnistmr, get_office31, get_officehome, get_visda2017c
from pytorch_adapt.validators import (
    AccuracyValidator, EntropyValidator, EntropyCombinedValidator,
    BNMValidator, BNMWithSourceValidator,
    IMValidator, IMCombinedValidator,
    ClassClusterValidator, PerClassValidator,
    SNDValidator, CORALValidator, MMDValidator, DeepEmbeddedValidator,
    RankMeValidator,
    HenryValidator, HenryV3Validator, HenryUpdatedValidator, GoukValidator, GoukV3Validator, GoukUpdatedValidator, ImprovedGoukValidator
)
...
VALIDATORS = {
    ...
    "src_train_target_train_bnm_score": lambda kwargs: (BNMWithSourceValidator(), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_bnm_score": lambda kwargs: (BNMWithSourceValidator(), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_bnm_score": lambda kwargs: (BNMWithSourceValidator(), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_bnm_score": lambda kwargs: (BNMWithSourceValidator(), {"src_train": "src_val", "target_train": "target_val"}),
    ...
    "src_train_target_train_mmd_score": lambda kwargs: (MMDValidator(mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_mmd_score": lambda kwargs: (MMDValidator(mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_mmd_score": lambda kwargs: (MMDValidator(mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_mmd_score": lambda kwargs: (MMDValidator(mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_val"}),

    "src_train_target_train_logits_mmd_score": lambda kwargs: (MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_logits_mmd_score": lambda kwargs: (MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_logits_mmd_score": lambda kwargs: (MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_logits_mmd_score": lambda kwargs: (MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_val"}),

    "src_train_target_train_preds_mmd_score": lambda kwargs: (MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_preds_mmd_score": lambda kwargs: (MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_preds_mmd_score": lambda kwargs: (MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_preds_mmd_score": lambda kwargs: (MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic")), {"src_train": "src_val", "target_train": "target_val"}),

    "src_train_target_train_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_val"}),

    "src_train_target_train_logits_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_logits_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_logits_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_logits_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="logits", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_val"}),

    "src_train_target_train_preds_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_train"}),
    "src_train_target_val_preds_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_train", "target_train": "target_val"}),
    "src_val_target_train_preds_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_train"}),
    "src_val_target_val_preds_mmd_per_class_score": lambda kwargs: (PerClassValidator(MMDValidator(layer="preds", mmd_kwargs=dict(mmd_type="quadratic"))), {"src_train": "src_val", "target_train": "target_val"}),
    ...
    "target_train_henry_v3_score": lambda kwargs: (HenryV3Validator(num_classes=kwargs["num_classes"]), {"src_val": "src_val", "target_train": "target_train"}),
    "target_val_henry_v3_score": lambda kwargs: (HenryV3Validator(num_classes=kwargs["num_classes"]), {"src_val": "src_val", "target_train": "target_val"}),

    "target_train_henry_updated_score": lambda kwargs: (HenryUpdatedValidator(num_classes=kwargs["num_classes"], src_val_at_init=kwargs["src_val_at_init"]), {"src_val": "src_val", "target_train": "target_train"}),
    "target_val_henry_updated_score": lambda kwargs: (HenryUpdatedValidator(num_classes=kwargs["num_classes"], src_val_at_init=kwargs["src_val_at_init"]), {"src_val": "src_val", "target_train": "target_val"}),
    ...
    "src_train_gouk_v3_score": lambda kwargs: (GoukV3Validator(num_classes=kwargs["num_classes"]), {"src_val": "src_train"}),
    "src_val_gouk_v3_score": lambda kwargs: (GoukV3Validator(num_classes=kwargs["num_classes"]), {"src_val": "src_val"}),

    "src_train_gouk_updated_score": lambda kwargs: (GoukUpdatedValidator(num_classes=kwargs["num_classes"], src_val_at_init=kwargs["src_val_at_init"]), {"src_val": "src_train"}),
    "src_val_gouk_updated_score": lambda kwargs: (GoukUpdatedValidator(num_classes=kwargs["num_classes"], src_val_at_init=kwargs["src_val_at_init"]), {"src_val": "src_val"}),

    "src_train_improved_gouk_score": lambda kwargs: (ImprovedGoukValidator(num_classes=kwargs["num_classes"]), {"src_val": "src_train"}),
    "src_val_improved_gouk_score": lambda kwargs: (ImprovedGoukValidator(num_classes=kwargs["num_classes"]), {"src_val": "src_val"}),

    "dev_features_max_score": lambda kwargs: (
        DeepEmbeddedValidator(
            temp_folder=kwargs["dev_temp"],
            layer="features",
            normalization="max"
        ),
...
class Validator():
    ...
    def compute(self, data, epoch):
        ...
        for name, (validator, input_keys) in self.validators.items():
            try:
                val = validator(**{key: data[value] for key, value in input_keys.items()})
            except:
...
if __name__ == "__main__":
    ...
    if args.algorithm == "source-only":
        args.validators = [v for v in args.validators if "acc_score" in v]

    src_val_at_init = torch.load(os.path.join(args.results_root, args.dataset, args.source, args.target, "source-only", "best_features.pt"))["src_val"]

    num_classes = DATASETS[args.dataset][1]
    chosen_validators = {key: VALIDATORS[key]({
        "num_classes": num_classes,
        "src_val_at_init": src_val_at_init,
        "dev_temp": os.path.join(".dev_temp", args.results_root, args.dataset, args.source, args.target, args.algorithm)}) for key in args.validators}
    validator = Validator(chosen_validators, "target_test_acc_score", 200)

    score_files = glob.glob(os.path.join(args.results_root, args.dataset, args.source, args.target, args.algorithm, "features*.pt"))
    print(f"Computing validators for {len(score_files)} checkpoints in {args.dataset}-{args.source[0].upper()+args.target[0].upper()} {args.algorithm} ")
    for f in score_files:
        for fl in ["fl3", "fl6"]:
            run_name = "{" + f.split("{")[1].split("}")[0] + "}"
            epoch = int(f.split("_")[-1].split(".")[0])

            scores_path = os.path.join(args.results_root, args.dataset, args.source, args.target, args.algorithm, f"post_scores_{run_name}_{epoch}_{fl}.json")
            scores_keys = []
            if os.path.exists(scores_path):
                ...
                if len(not_computed) == 0:
                    print(f"{args.dataset}-{args.source[0].upper()+args.target[0].upper()} {args.algorithm} {run_name}_{epoch}_{fl} already computed all validators, skipping.")
                    continue
            else:
            ...
            if not os.path.exists(scores_path):
                ...
                if args.dataset == "mnistm":
                    torch.manual_seed(0)
                    for key in eval_data:
                        idxs = torch.randperm(len(eval_data[key]["labels"]))[:1000]
                        for layer in eval_data[key]:
                            eval_data[key][layer] = eval_data[key][layer][idxs]
                eval_data = {key: {key2: val2.to("cuda:0") for key2, val2 in val.items()} for key, val in eval_data.items()}
                validator.compute(eval_data, epoch - 1)
                validator.print()
                validator.save(args.results_root, args.dataset, args.source, args.target, args.algorithm, f"post_scores_{run_name}_{epoch}_{fl}.json")
            else:
                print(f"Validating {not_computed} for {args.dataset}-{args.source[0].upper()+args.target[0].upper()} {args.algorithm} {run_name}_{epoch}_{fl}.")
                eval_data = torch.load(f)
                for key in eval_data:
                    eval_data[key]["features"] = eval_data[key][fl]
                # run MNIST faster
                ...
                uncomputed_validators = {key: VALIDATORS[key]({
                    "num_classes": num_classes,
                    "src_val_at_init": src_val_at_init,
                    "dev_temp": os.path.join(".dev_temp", args.results_root, args.dataset, args.source, args.target, args.algorithm)}) for key in not_computed}
